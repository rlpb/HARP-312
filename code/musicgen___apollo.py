# -*- coding: utf-8 -*-
"""MusicGen > Apollo.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19W6ZEe_8jW4mm_wdVsxNjRK6klgv0OPJ
...
- Non-invasive: does not change global logging policies used by other blocks
"""))
...
DURATION = 10  # @param {type:"slider", min:5, max:15, step:1}
OUTPUT_PATH = "/content/musicgen_1.wav"  # @param {"type":"string"}
...
# User parameters
# ============================================================
INPUT_PATH  = "/content/musicgen_1.wav"      # @param {"type":"string"}
OUTPUT_PATH = "/content/musicgen_pc_1.wav"   # @param {"type":"string"}
...
# User parameters
# ============================================================
INPUT_PATH  = "/content/musicgen_pc_1.wav"   # @param {"type":"string"}
OUTPUT_PATH = "/content/apollo_1.wav"        # @param {"type":"string"}
...
# Minimal verification view (utility)
ANALYSIS_SR = 44100
N_FFT = 2048
HOP   = 512
DIFF_DB_RANGE = 12.0
